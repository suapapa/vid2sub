...
| YouTube Existing Captions Reuse | ✅ Done | Prefer manual then auto captions via `yt-dlp` metadata; skip audio / vocal isolation / STT when found. `--lang` selects the track; falls back to STT otherwise. |
